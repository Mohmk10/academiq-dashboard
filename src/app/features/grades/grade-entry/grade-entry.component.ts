            ...
            <table mat-table [dataSource]="rows" class="w-full grade-entry-table">
              ...
              <ng-container matColumnDef="note">
                ...
                <td mat-cell *matCellDef="let row">
                  <input type="number" class="w-20 px-2 py-1 border rounded text-center text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors"
              ...
              <ng-container matColumnDef="commentaire">
                ...
                <td mat-cell *matCellDef="let row">
                  <input type="text" class="w-full px-2 py-1 border rounded text-sm focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors"
